<p align="center" style="text-align: center">
  <img src="https://github.com/matrix37/TorrServer/assets/144587546/53f7175a-cda4-4a06-86b6-2ac07582dcf1" width="33%"><br/>
</p>
...
<p align="center">
  ...
  <br/>
  <br/>
  <a href="https://github.com/matrix37/TorrServer/blob/master/LICENSE">
    <img alt="GitHub" src="https://img.shields.io/github/license/matrix37/TorrServer"/>
  </a>
  <a href="https://goreportcard.com/report/github.com/matrix37/TorrServer">
    <img src="https://goreportcard.com/badge/github.com/matrix37/TorrServer" />
  </a>
  <a href="https://pkg.go.dev/github.com/matrix37/TorrServer">
    <img src="https://pkg.go.dev/badge/github.com/matrix37/TorrServer.svg" alt="Go Reference"/>
  </a>
  <a href="https://github.com/matrix37/TorrServer/issues">
    <img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat" alt="CodeFactor" />
  </a>
  <a href="https://github.com/matrix37/TorrServer/actions/workflows/docker_image.yml" rel="nofollow">
    <img src="https://img.shields.io/github/actions/workflow/status/matrix37/TorrServer/docker_image.yml?logo=Github" alt="Build" />
  </a>
  <a href="https://github.com/matrix37/TorrServer/releases" rel="nofollow">
    <img alt="GitHub release (latest SemVer)" src="https://img.shields.io/github/v/release/matrix37/TorrServer?label=version"/>
  </a>
  <a href="https://github.com/matrix37/TorrServer/tags" rel="nofollow">
    <img alt="GitHub tag (latest SemVer pre-release)" src="https://img.shields.io/github/v/tag/matrix37/TorrServer?include_prereleases&label=pre-release"/>
  </a>
</p>
...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/matrix37/TorrServer)
...
Download the application for the required platform in the [releases](https://github.com/matrix37/TorrServer/releases) page. After installation, open the link <http://127.0.0.1:8090> in the browser.
...
```bash
curl -s https://raw.githubusercontent.com/matrix37/TorrServer/master/installTorrServerLinux.sh | sudo bash
```
...
```bash
curl -s https://raw.githubusercontent.com/matrix37/TorrServer/master/installTorrServerLinux.sh -o installTorrServerLinux.sh && chmod 755 installTorrServerLinux.sh
```
...
```bash
curl -s https://raw.githubusercontent.com/matrix37/TorrServer/master/installTorrServerMac.sh -o installTorrserverMac.sh && chmod 755 installTorrServerMac.sh && bash ./installTorrServerMac.sh
```
...
```bash
docker run --rm -d --name torrserver -p 8090:8090 ghcr.io/matrix37/torrserver:latest
```
...
```bash
docker run --rm -d --name torrserver -v ~/ts:/opt/ts -p 8090:8090 ghcr.io/matrix37/torrserver:latest
```
...
services:
    torrserver:
        image: ghcr.io/matrix37/torrserver
...
More info at <https://github.com/matrix37/TorrServer/tree/master/web#readme>
