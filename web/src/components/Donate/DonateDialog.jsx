    ...
    <StyledDialog open onClose={onClose} aria-labelledby='form-dialog-title' fullWidth maxWidth='xs' ref={ref}>
      ...
      <DialogContent>
        ...
        <ButtonGroup variant='outlined' color='secondary' aria-label='contained primary button group'>
          <Button onClick={() => window.open('https://boosty.to/9000000', '_blank')}>Boosty</Button>
          ...
          {/* <Button onClick={() => window.open('https://qiwi.com/n/9000000', '_blank')}>QIWI</Button> */}
          {/* <Button onClick={() => window.open('https://www.paypal.com/paypalme/9000000', '_blank')}>PayPal</Button> */}
        </ButtonGroup>
        {/* </ListItem> */}
