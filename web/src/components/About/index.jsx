        ...
        <DialogWrapper>
          ...
          <div style={{ overflow: 'auto' }}>
            ...
            <Section>
              ...
              <div>
                <LinkComponent name={t('ProjectSource')} link='https://github.com/matrix37/TorrServer' />
                <LinkComponent name={t('Releases')} link='https://github.com/matrix37/TorrServer/releases' />
